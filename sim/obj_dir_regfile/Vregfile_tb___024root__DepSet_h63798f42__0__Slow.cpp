...
VL_ATTR_COLD void Vregfile_tb___024root___eval_static__TOP(Vregfile_tb___024root* vlSelf) {
    ...
    vlSelf->regfile_tb__DOT__waddr = 0U;
    vlSelf->regfile_tb__DOT__wdata = 0U;
    vlSelf->regfile_tb__DOT__raddr1 = 0U;
    vlSelf->regfile_tb__DOT__raddr2 = 0U;
}
...
#endif
            VL_FATAL_MT("../rtl/../tb/regfile_tb.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vregfile_tb___024root___dump_triggers__act(Vregfile_tb___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(negedge regfile_tb.clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vregfile_tb___024root___dump_triggers__nba(Vregfile_tb___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(negedge regfile_tb.clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vregfile_tb___024root___ctor_var_reset(Vregfile_tb___024root* vlSelf) {
    ...
    vlSelf->regfile_tb__DOT__we = VL_RAND_RESET_I(1);
    vlSelf->regfile_tb__DOT__waddr = VL_RAND_RESET_I(5);
    vlSelf->regfile_tb__DOT__wdata = VL_RAND_RESET_I(32);
    vlSelf->regfile_tb__DOT__raddr1 = VL_RAND_RESET_I(5);
    vlSelf->regfile_tb__DOT__raddr2 = VL_RAND_RESET_I(5);
    vlSelf->regfile_tb__DOT__rdata1 = VL_RAND_RESET_I(32);
    vlSelf->regfile_tb__DOT__rdata2 = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->regfile_tb__DOT__ref_regs[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->regfile_tb__DOT__num_tests = 0;
    vlSelf->regfile_tb__DOT__num_fails = 0;
    vlSelf->regfile_tb__DOT__unnamedblk1__DOT__i = 0;
    vlSelf->regfile_tb__DOT__unnamedblk2__DOT__i = 0;
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->regfile_tb__DOT__dut__DOT__regs[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->regfile_tb__DOT__dut__DOT__unnamedblk1__DOT__i = 0;
